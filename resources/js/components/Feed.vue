	...
	<div>
		<div class="container">
			<div class="row">
				...
				<slot name="blockmainfeed"></slot>
				<slot name="blockleftfeed"></slot>
				<slot name="blockrightfeed"></slot>
		...
		<!-- FIM Modal Atualizar foto de perfil -->
		...
		<!-- ... FIM modal atualizar foto de capa -->
